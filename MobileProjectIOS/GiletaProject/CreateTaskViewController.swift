...
class CreateTaskViewController: UIViewController {
    ...
    private func makeFlagButton() -> UIButton {
        ...
        button.setTitle("⚑ Флаг", for: .normal)
        button.addTarget(self, action: #selector(toggleFlag), for: .touchUpInside)
        flagButtonRef = button
        updateFlagUI()
        return button
    }
    ...
    @objc private func saveTapped() {
        guard let title = titleField.text, title.isEmpty == false else { return }
